                         ...
                         <tbody>
                              ...
                              ?>
                                   <tr style="white-space:nowrap;">
                                        ...
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getNameCompany() ?> </li>
                                        </td>
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getTitle() ?></li>
                                        </td>
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getCareerDescription() ?> </li>
                                        </td>
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getPositionDescription() ?></li>
                                        </td>
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getWorkLoad() ?></li>
                                        </td>
                                        <td>
                                             <li class="list-group-item list-group-item-info"><?php echo $offer->getSalary() ?></li>
                                        </td>
                                        <td>
                                                                      ...
                                                                      <div class="row">
                                                                           ...
                                                                           <div class="form">
                                                                                ...
                                                                                <select class="form-control" name="idCompany" id="Companys<?= $offer->getId() ?>">
                                                                                     ...
                                                                                     ?>
                                                                                          <option value=<?= $company->getIdCompany() ?> <?php if ($company->getIdCompany()  == $offer->getIdCompany()) {
                                                                                                                                                 echo 'selected="selected"';
                                                                                                                                            } ?>><?= $company->getNameCompany() ?></option>
                                                                           ...
                                                                           <div class="form">
                                                                                ...
                                                                                <select class="form-control" name="idJobPosition" id="JobPositions<?= $offer->getId() ?>">
                                                                                     ...
                                                                                     ?>
                                                                                          <option value=<?= $job->getJobPositionId() ?> <?php if ($offer->getIdJobPosition() == $job->getJobPositionId()) {
                                                                                                                                                 echo 'selected="selected"';
                                                                                                                                            } ?>><?= $job->getDescription() ?></option>
